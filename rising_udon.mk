#
# Copyright (C) 2023-2026 The RisingOS Project
#
...
# Inherit RisingOS / Lineage common configuration
$(call inherit-product-if-exists, vendor/rising/config/common.mk)
